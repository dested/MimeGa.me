...
//todo
        ...
        public RaphaelElement Click(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        public RaphaelElement Drag(Event onMove, Event onStart, Event onEnd) //todo
        {
            return default( RaphaelElement );
        }
        ...
        [ScriptName("dblclick")]
        public RaphaelElement DoubleClick(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }
        ...
        public void Hover(Event f_in, Event f_out) {}
        ...
        public RaphaelElement MouseDown(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("mousemove")]
        public RaphaelElement MouseMove(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("mouseout")]
        public RaphaelElement MouseOut(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("mouseover")]
        public RaphaelElement MouseOver(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("mouseup")]
        public RaphaelElement MouseUp(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }
        ...
        public RaphaelElement TouchCancel(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("touchend")]
        public RaphaelElement TouchEnd(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("touchmove")]
        public RaphaelElement TouchMove(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("touchstart")]
        public RaphaelElement TouchStart(HtmlEventHandler handler)
        {
        ...
        public RaphaelElement UnTouchCancel(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("untouchend")]
        public RaphaelElement UnTouchEnd(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("untouchmove")]
        public RaphaelElement UnTouchMove(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("untouchstart")]
        public RaphaelElement UnTouchStart(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("unclick")]
        public RaphaelElement UnClick(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }
        ...
        public RaphaelElement UnDoubleClick(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("unmousedown")]
        public RaphaelElement UnMouseDown(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("unmousemove")]
        public RaphaelElement UnMouseMove(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("unmouseout")]
        public RaphaelElement UnMouseOut(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("unmouseover")]
        public RaphaelElement UnMouseOver(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("unmouseup")]
        public RaphaelElement UnMouseUp(HtmlEventHandler handler)
        {
            return default( RaphaelElement );
        }

        [ScriptName("unhover")]
        public void UnHover(Event f_in, Event f_out) {}
    }
    [Serializable]
    [IgnoreNamespace]
    [Imported()]
